...
✅ - задача решена полностью (при клике перекинет на решение задачи)  
☑️ - решена первая часть (при клике перекинет на решение задачи)  
❌ - не приступал к решению (при клике перекинет на шаблонный пустой файл)
